          ...
          <div class="card border-danger text-danger bg-dark mt-2">
            ...
            <div class="card-body row">
              <div class="col sm-4">
                ...
                >{{es.deaths + cr.deaths + ni.deaths + hn.deaths + gt.deaths + pn.deaths + bl.deaths}}</p>
              ...
              <div class="col sm-4">
                ...
                <p class="card-text" v-if="seleccion == 'CENTRO AMERICA'">
                  {{es.todayDeaths + cr.todayDeaths + ni.todayDeaths + hn.todayDeaths + gt.todayDeaths + pn.todayDeaths + bl.todayDeaths}}
                  <span class="badge badge-secondary">Nuevo</span>
                </p>
                <p class="card-text" v-if="seleccion == 'El Salvador'">
                  {{es.todayDeaths}}
                  <span class="badge badge-secondary">Nuevo</span>
                </p>
                <p class="card-text" v-if="seleccion == 'Costa Rica'">
                  {{cr.todayDeaths}}
                  <span class="badge badge-secondary">Nuevo</span>
                </p>
                <p class="card-text" v-if="seleccion == 'Nicaragua'">
                  {{ni.todayDeaths}}
                  <span class="badge badge-secondary">Nuevo</span>
                </p>
                <p class="card-text" v-if="seleccion == 'Honduras'">
                  {{hn.todayDeaths}}
                  <span class="badge badge-secondary">Nuevo</span>
                </p>
                <p class="card-text" v-if="seleccion == 'Guatemala'">
                  {{gt.todayDeaths}}
                  <span class="badge badge-secondary">Nuevo</span>
                </p>
                <p class="card-text" v-if="seleccion == 'Panama'">
                  {{pn.todayDeaths}}
                  <span class="badge badge-secondary">Nuevo</span>
                </p>
                <p class="card-text" v-if="seleccion == 'Belice'">
                  {{bl.todayDeaths}}
                  <span class="badge badge-secondary">Nuevo</span>
                </p>
              </div>
            ...
            <div class="card-body row">
              <div class="col sm-6">
                ...
                <p
                  class="card-text"
                  v-if="seleccion == 'CENTRO AMERICA'"
                >{{es.cases + cr.cases + ni.cases + hn.cases + gt.cases + pn.cases + bl.cases}}</p>
              ...
              <div class="col sm-6">
                ...
                <p
                  class="card-text"
                  v-if="seleccion == 'CENTRO AMERICA'"
                >{{es.active + cr.active + ni.active + hn.active + gt.active + pn.active + bl.active}}</p>
              ...
              <div class="col sm-4">
                <h5 class="card-title">Hoy</h5>
                <p class="card-text" v-if="seleccion == 'CENTRO AMERICA'">
                  {{es.todayCases + cr.todayCases + ni.todayCases + hn.todayCases + gt.todayCases + pn.todayCases + bl.todayCases}}
                  <span class="badge badge-secondary">Nuevo</span>
                </p>
                <p class="card-text" v-if="seleccion == 'El Salvador'">
                  {{es.todayCases}}
          ...
          <div class="card border-warning text-warning bg-dark mt-2">
            ...
            <div class="card-body">
              ...
              <p
                class="card-text"
                v-if="seleccion == 'CENTRO AMERICA'"
              >{{es.critical + cr.critical + ni.critical + hn.critical + gt.critical + pn.critical + bl.critical}}</p>
          ...
          <div class="card border-success text-success bg-dark mt-2">
            ...
            <div class="card-body">
              ...
              <p
                ...
                class="card-text"
                v-if="seleccion == 'CENTRO AMERICA'"
              >{{es.recovered + cr.recovered + ni.recovered + hn.recovered + gt.recovered + pn.recovered + bl.recovered}}</p>
...
export default {
  ...
  methods: {
    elsalvador() {
      ...
      axios
        .get("https://coronavirus-19-api.herokuapp.com/countries/el%20salvador")
        .then(res => {
          console.log(res);
    ...
    costarica() {
      ...
      axios
        .get("https://coronavirus-19-api.herokuapp.com/countries/costa%20rica")
        .then(res => {
          console.log(res);
    ...
    nicaragua() {
      ...
      axios
        .get("https://coronavirus-19-api.herokuapp.com/countries/nicaragua")
        .then(res => {
          console.log(res);
    ...
    honduras() {
      ...
      axios
        .get("https://coronavirus-19-api.herokuapp.com/countries/honduras")
        .then(res => {
          console.log(res);
    ...
    guatemala() {
      ...
      axios
        .get("https://coronavirus-19-api.herokuapp.com/countries/guatemala")
        .then(res => {
          console.log(res);
    ...
    panama() {
      ...
      axios
        .get("https://coronavirus-19-api.herokuapp.com/countries/panama")
        .then(res => {
          console.log(res);
    ...
    belice() {
      ...
      axios
        .get("https://coronavirus-19-api.herokuapp.com/countries/belize")
        .then(res => {
          console.log(res);
